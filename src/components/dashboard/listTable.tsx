      ...
      <div className="overflow-x-auto">
        {filteredPairs.length > 0 ? (
            ...
            <TableBody>
              {filteredPairs.map((pair) => (
                ...
                >
                  ...
                  <TableCell className="text-right">
                    {pair.txns?.h24?.buys || "N/A"}
                  </TableCell>
                  <TableCell className="text-right">
                    {renderPriceChange(pair.priceChange?.m5)}
                  </TableCell>
                  <TableCell className="text-right">
                    {renderPriceChange(pair.priceChange?.h1)}
                  </TableCell>
                  <TableCell className="text-right">
                    {renderPriceChange(pair.priceChange?.h6)}
                  </TableCell>
                  <TableCell className="text-right">
                    {renderPriceChange(pair.priceChange?.h24)}
                  </TableCell>
                  <TableCell className="text-right">
          ...
          <p className="text-center text-white">
            Token not found or not listed on Xdegen.
          </p>
        )}
      </div>
    </div>
